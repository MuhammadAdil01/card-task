  ...
  return (
    ...
    <section section className='flex items-center justify-center gap-10 mt-10'>
        <div className='border py-5 px-4 rounded-md flex items-center flex-col w-80'>
            <h2 className='border-b border-gray-700 text-3xl pb-2 text-gray-700 text-center leading-10 mb-5'>Calender Wise Cards</h2>
            <div className=''>
                <ul className='pl-4 list-disc text-[1.3rem] flex flex-col gap-2 mb-10 mt-5 text-gray-700 font-normal'>
                    <li className='mb-2'>January</li>
                    <li className='mb-2'>Feburary</li>
                    <li className='mb-2'>March</li>
                    <li className='mb-2'>April</li>
                </ul>
        ...
        <div className='border py-5 px-4 rounded-md flex items-center flex-col w-80'>
            ...
            <div className=''>
                <ul className='pl-4 list-disc text-[1.3rem] flex flex-col gap-2 mb-10 mt-5 text-gray-700 font-normal'>
                    <li className='mb-2'>May</li>
                    <li className='mb-2'>June</li>
                    <li className='mb-2'>July</li>
                    <li className='mb-2'>August</li>
                </ul>
                <button className='w-full bg-white border-pink-utility border text-pink-utility rounded-md py-2 px-4 md:px-2 text-lg md:text-xl hover:bg-pink-utility hover:text-white transition-all duration-200  font-text-shadow-italic font-semibold'>get Now</button>
            </div>
        </div>
    </section>
</div>
